...
export const SkillData:Skills[] = [
    ...
    ,
    {
        ...
        text:'다양한 선택자와 속성을 활용하여 웹 페이지의 디자인과 레이아웃을 세밀하게 제어합니다.Flexbox 및 keyframe, animation 등을 이용한 반응형 디자인 구현 경험이 있습니다'
    }
    ,
    {
        skill: 'React',
        ...
        text:'JSX 문법을 활용하여 컴포넌트 기반의 UI를 구성하고, 상태와 속성을 관리하여 구조적이고 재사용 가능한 UI를 설계합니다.또한 다양한 Hook을 활용하여 높은 성능의 웹 애플리케이션을 개발합니다'
    }
    ,
    {
        skill: 'Redux',
    ...
    ,
    {
        ...
        text:'Styled-Components를 활용하여 CSS-in-JS 방식으로 웹 애플리케이션의 스타일을 구성합니다.컴포넌트 단위로 스타일을 관리하여 유지보수성과 재사용성을 높인 컴포넌트를 제작 할 수 있습니다. Keyframe을 이용한 애니메이션 적용 경험과 GlobalStyles를 이용한 전역 스타일 관리 경험이 있습니다.'
    }
    ,
    {
        skill: 'AXIOS',
    ...
    ,
    {
        ...
        text:'AWS 클라우드 서비스에 대한 학습 중이며, 다양한 서비스를 탐구하고 클라우드 기술을 활용하여.서버리스 아키텍처 및 배포 프로세스를 습득하는 데 집중하고 있습니다.aws-sdk와 S3를 이용해 웹에서 데이터를 업로드/다운로드한 경험이 있습니다.'
    }
    ,
    {
        skill: 'Netlify',
