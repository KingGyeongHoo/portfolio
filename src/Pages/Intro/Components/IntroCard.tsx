    ...
    if (iconName === 'blog') {
        return (
            <>
                ...
                <div>
                    <p>학습 내용을 기억하기 위해 <span>블로그</span>를 운영 중입니다.</p>
                    <p>Frontend Skill,  코딩 테스트 풀이, CS 지식 등 </p>
                    <p>다양한 분야의 게시물을 <span>100개</span> 이상 작성하였습니다.</p>
                </div>
            </>
        )
        ...
        return (
            <>
                ...
                <div>
                    ...
                    <p><span>GTQ 1급(Photoshop)</span> 자격증을 취득했습니다.</p>
        ...
        return (
            <>
                ...
                <div>
                    <p><span>Javascript</span> 활용 능력을 높이고자</p>
                    <p>프로그래머스 알고리즘 문제를 꾸준히 풀고 있습니다.</p>
                    <p>현재까지 <span>275개</span> 이상의 문제를 해결했습니다.</p>
                </div>
            </>
        )
        ...
        return (
            <>
                ...
                <div>
                    ...
                    <p>금융, 부동산, 전기차 등 <span>4개</span>의 프로젝트를 수행했습니다</p>
                </div>
            </>
        )
    } else {
